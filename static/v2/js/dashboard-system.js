    ...
    try {
        ...
        try {
            ...
            if (response.ok) {
                ...
                console.log('📥 Loaded config for integration snippet:', {
                    has_api_key: !!apiKey,
                ...
                if (!apiKey) {
                    console.log('⚠️ No API key found, reloading to get generated key...');
                    ...
                    if (reloadResponse.ok) {
                        ...
                        console.log('✅ Reloaded config, API key:', apiKey ? 'Found' : 'Still missing');
                    }
                }
            } else {
                console.error('❌ Failed to load chatbot config:', response.status, response.statusText);
            }
        } catch (e) {
